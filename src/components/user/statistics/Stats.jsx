...
class Stats extends Component {
  ...
  render() {
    ...
    if (this.state.badRequest) {
      graph = this.state.firstLoad ? (
        <></>
      ) : (
        <BadData history={this.props.history} />
      );
    } else {
      graph = this.state.firstLoad ? (
        <></>
        ...
        <Graph
          ...
          currentThermostat={
            this.state.thermostats[this.state.currentIndex].thermostatId
          }
          ...
          <Grid container spacing={24}>
            ...
            <Grid item xs={6}>
              <DropdownList
                data={thermostats}
                defaultValue={
                  this.state.thermostats[this.state.currentIndex].roomName
                }
                valueField="id"
                textField="name"
                onChange={async value => {
